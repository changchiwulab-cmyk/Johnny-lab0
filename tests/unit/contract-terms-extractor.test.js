...
describe("ContractTermsExtractor", () => {
  ...
  describe("extractJurisdiction()", () => {
    it("should detect California", () => {
      expect(extractor.extractJurisdiction("laws of California")).toBe(
        "California",
      );
    });

    it("should detect New York", () => {
      expect(extractor.extractJurisdiction("courts of New York")).toBe(
        "New York",
      );
    });

    it("should detect Delaware", () => {
      expect(extractor.extractJurisdiction("incorporated in Delaware")).toBe(
        "Delaware",
      );
    });
  ...
  describe("extractConfidentialityPeriod()", () => {
    ...
    it("should return null numeric_value when not specified", () => {
      const result = extractor.extractConfidentialityPeriod(
        "no period mentioned",
      );
  ...
  describe("extractObligations()", () => {
    it("should detect confidentiality obligation", () => {
      const obligations = extractor.extractObligations(
    ...
    it("should detect multiple obligations", () => {
      const text =
        "confidentiality protect indemnification insurance compliance";
  ...
  describe("extractPermittedUse()", () => {
    it("should detect permitted use clause", () => {
      const result = extractor.extractPermittedUse(
        "permitted use for evaluation only",
      );
    ...
    it('should detect "use may only" pattern', () => {
      const result = extractor.extractPermittedUse(
        "use may only be for business purposes",
      );
      expect(result.description).toContain("limited");
    });
  ...
  describe("extractReturnOfInformation()", () => {
    it("should detect return clause", () => {
      const result = extractor.extractReturnOfInformation(
        "shall return all documents",
      );
  ...
  describe("extractSLO()", () => {
    it("should detect response time SLO", () => {
      const result = extractor.extractSLO(
  ...
  describe("extractUptimeGuarantee()", () => {
    it("should extract 99.9% uptime", () => {
      const result = extractor.extractUptimeGuarantee(
  ...
  describe("extractWarranty()", () => {
    it("should detect warranty clause", () => {
      const result = extractor.extractWarranty(
